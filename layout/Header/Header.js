...
const Header = () => {
  ...
  return (
    <div className={cx('header')}>
      ...
      <Link href='/subjects' className={cx('head-link')}>Môn học</Link>
      ...
      <Link href='/news' className={cx('head-link')}>Lớp học trực tuyến</Link>
  ...
  return (
    <div className={cx('menu-mobile')}>
       <div className={cx('mb-user')}>
        <Link href='/account/login' className={cx('mb-login')}>Log in</Link>
        <Link href='/account/login' className={cx('mb-signup')}>Sign up</Link>
       </div>
       <div className={cx('mb-list')}>
       <Link href='/subjects' className={cx('mb-link')}>Môn học</Link>
       <Link href='/news' className={cx('mb-link')}>Tin tức</Link>
       <Link href='/news' className={cx('mb-link')}>Lớp học trực tuyến</Link>
