            ...
            <div key={element.LmsTaskCode} className={cx("card")}>
              <div className={cx("card-body")}>
                ...
                <div className={cx("card-time")}>
                  <div className={cx("status")}>
                    ...
                    <span>{diffMoment(element.BeginTime, element.EndTime)}</span>
                  </div>
                  <div className={cx("timeStart")}>
                    <span>[{moment(element.BeginTime).format('DD : MM : YYYY')}]</span>
                    {element.EndTime && <span>[{moment(element.EndTime).format('DD : MM : YYYY')}]</span>}
                  </div>
                </div>
              </div>
              <div className={cx("card-footer")}>
                <div className={cx("listIcon")}>
                  ...
                  <span><i className="fa-solid fa-align-center"></i></span>
