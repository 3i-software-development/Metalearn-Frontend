...
const NavbarExam = ({ query, handleQuery, totalAssigment, totalShared }) => {
  ...
  const handleChangeType = (type) => {
    type === "assigment"
      ? handleQuery({ ...query, onlyAssignment: true, onlyShared: false })
      : handleQuery({ ...query, onlyAssignment: false, onlyShared: true });
  };
      ...
      <div className={cx("sort")}>
        ...
        <div className={cx("tabTitles")}>
          {query.onlyAssignment ? (
            ...
            <span
              className={cx("bedwars")}
              onClick={() => handleChangeType("assigment")}
            >
              Được giao
              <p>[ {totalAssigment} ]</p>
            </span>
        ...
        <div className={cx("content-sort-container")}>
          <p>Nội dung</p>
          <Input className={cx("select-container")} placeholder="Nội dung" />
        </div>
        <div className={cx("content-sort-container")}>
          <p>Người tạo</p>
          <Select
