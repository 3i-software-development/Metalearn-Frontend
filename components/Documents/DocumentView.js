  ...
  return (
    <div className={cx("document-content")}>
      ...
      <div className={cx("document-infor")}>
        <div>
          <h2 style={{ fontSize: "36px" }}>{getFileName(valueDoc.src)}</h2>
          <p style={{ fontSize: "20px" }}>Size: 15Mb</p>
          <p style={{ fontSize: "20px" }}>Uploaded: 1/2/2022</p>
          <p style={{ fontSize: "20px" }}>Last opented: 1/2/2022</p>
        </div>
        <div>
          <a href={valueDoc.src} target="_blank">
            <BsArrowsFullscreen />
          </a>
          <BsDownload />
      ...
      <div className={cx("document-iframe")}>
        <iframe
          src={valueDoc.src}
          width={valueDoc.width || "100%"}
          height={valueDoc.height || "100%"}
